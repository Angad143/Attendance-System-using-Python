...
home.configure(font=('arial', 11, 'bold'), bg='red', fg='black')
...
#Entry of date
e_date = DateEntry(root, width=12, background='blue', foreground='white', borderwidth=2, font=fontStyle_d)
...
def submit_attendance():
    ...
    for i, attendance in enumerate(records):
        sEnroll, sName, sRoll = attendance
        query = "INSERT INTO a_java (date, sEnroll, sName, sRoll, status) VALUES (%s, %s, %s, %s, %s)"
...
submit.configure(font=('arial', 14, 'bold'), bg='green', fg='white')
...
insert.configure(font=('arial', 13, 'bold'), bg='grey', fg='white')
...
remove.configure(font=('arial', 13, 'bold'), bg='blue', fg='white')
